...
% Rent_Amount=1000000;
ftp=0.02;
Max_=-1000000*ones(1,302);
T=zeros(1,302);
for i=[9 18 20 31 37 38 39 40 50 72 74 75 138 195] %对每一个企业
    ...
    for t=0.04:0.001:0.1 %贷款年利率
        E=eval(Percentage(i)*t/(1-WeiYueLv(i))*(1-subs(f)));
        Antici_loss=WeiYueLv(i)*Percentage(i);
        Costing=ftp*Percentage(i);
